...
I am currently developing my own linalg library for my own stuff.  This library is a light weight Linear Algebra C++17 library. 

CAVEAT: early development stage. *Do not use it right now!* 
...
#+begin_src cpp :eval never
assign(V, _plus_, _product_, _product_, _transpose_, M, U, _product_, _lhs_);
#+end_src
