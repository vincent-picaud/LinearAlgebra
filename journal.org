...
**** vector_comparison_operators.hpp                             :Bug:Caveat:
     :PROPERTIES:
     :ID:       3bb0fbb6-b81f-406b-be4f-640a7f9a4089
     :END:
...
**** CRTP Object Slicing                                   :Important:Design:

   Back link: [[file:src/LinearAlgebra/dense/vector_crtp.hpp][vector_crtp.hpp]]
...
;
   ...
   in the last CRTP object (where last means: just before a concrete instance), here "Vector <- Dense_Vector_Crtp"
