...
(setq org-publish-project-alist
	...
	;; Main
	("LinearAlgebra",
	 :components ("LinearAlgebra-org-files" "LinearAlgebra-data-files")
	 )
	)
      )
...
(setq my-www-links-filename (concat my-project-root "misc/www_links.org"))
(setq my-journal-filename (concat my-project-root "misc/journal.org"))
(setq my-todo-filename (concat my-project-root "misc/todo.org"))
