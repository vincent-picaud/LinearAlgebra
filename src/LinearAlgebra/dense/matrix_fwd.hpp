...
namespace LinearAlgebra
{
  ...
  using Strict_Lower_Triangular_Matrix =
      Default_Matrix<T, Matrix_Special_Structure_Enum::Triangular_Strict,
                     Matrix_Storage_Mask_Enum::Lower_Strict, std::size_t, std::size_t, std::size_t>;
  ...
  using Strict_Upper_Triangular_Matrix =
      Default_Matrix<T, Matrix_Special_Structure_Enum::Triangular_Strict,
                     Matrix_Storage_Mask_Enum::Upper_Strict, std::size_t, std::size_t, std::size_t>;
  ...
  using Generic_Matrix_View = Default_Matrix_View<ELEMENT_TYPE, SPECIAL_STRUCTURE, MASK,
                                                  std::size_t, std::size_t, std::size_t>;
