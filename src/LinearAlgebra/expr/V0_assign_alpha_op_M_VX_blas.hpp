...
namespace LinearAlgebra
{
  ...
  {
    // redirect
    assign(selected, vector0, _plus_, _product_, _product_, alpha.impl(), op1, matrix1, vector1,
           _product_, ALPHA_IMPL(0), _lhs_);
  ...
  assign(const Expr_Selector<Expr_Selector_Enum::Blas> selected,
         Dense_Vector_Crtp<VECTOR0_IMPL>& vector0, const _product_t_, const _product_t_,
         const Scalar_Crtp<ALPHA_IMPL>& alpha, const _matrix_unary_op_t_<OP1_ENUM> op1,
         const _inverse_t_, const Dense_Matrix_Crtp<MATRIX1_IMPL>& matrix1, const _lhs_t_)
      -> std::enable_if_t<
          // Supported matrix op?
          Blas::Support_CBlas_Transpose_v<OP1_ENUM> &&
          // Same scalar everywhere
  ...
  assign(const Expr_Selector<Expr_Selector_Enum::Blas> selected,  // Undefined implementation
         Dense_Vector_Crtp<VECTOR0_IMPL>& vector0, const _product_t_, const _product_t_,
         const Scalar_Crtp<ALPHA_IMPL>& alpha, const _matrix_unary_op_t_<OP1_ENUM> op1,
         const _inverse_t_, const Dense_Matrix_Crtp<MATRIX1_IMPL>& matrix1,
         const Dense_Vector_Crtp<VECTOR1_IMPL>& vector1)
      -> std::enable_if_t<
          // Supported matrix op?
          Blas::Support_CBlas_Transpose_v<OP1_ENUM> &&
