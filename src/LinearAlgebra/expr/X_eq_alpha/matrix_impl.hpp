...
namespace LinearAlgebra
{
  ...
  void
  assign(const Expr_Selector<Expr_Selector_Enum::Generic> selected, Dense_Matrix_Crtp<M0_IMPL>& M0,
  ...
  assign(const Expr_Selector<Expr_Selector_Enum::Static> selected, Dense_Matrix_Crtp<M0_IMPL>& M0,
         const Scalar_Crtp<ALPHA_IMPL>& alpha)
  {
    assign_helper(M0, alpha);
